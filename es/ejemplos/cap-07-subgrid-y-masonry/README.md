...
- **Subgrid**: una rejilla de cards con títulos de distinta altura. Cada card ocupa las tres filas del padre con `grid-template-rows: subgrid`, así los cuerpos y las barras de pie quedan alineados en todas las cards. Sin medir, sin alturas fijas, sin JS.
